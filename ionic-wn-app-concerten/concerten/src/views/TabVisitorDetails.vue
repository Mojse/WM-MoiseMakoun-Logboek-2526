<template>
	<ion-page>
		...
		<ion-content :fullscreen="true">
			...
			<ion-list>
				<ion-item>{{bezoekerData.first_name}}</ion-item>
                <ion-item>{{bezoekerData.last_name}}</ion-item>
                <ion-item>{{bezoekerData.birth_date}}</ion-item>
                <ion-item>{{bezoekerData.email}}</ion-item>
			</ion-list>
